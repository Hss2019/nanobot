...
If you discover a security vulnerability in CMClaw, please report it by:
...
- ✅ Run CMClaw with a dedicated user account
...
- Subscribe to security advisories for CMClaw and its dependencies
